        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-5">
                <ul class="list-unstyled link">
                    ...
                    <li><a href="${pageContext.request.contextPath}/#">Terms &amp; Conditions</a></li>
            ...
            <div class="col-md-3 mb-5">
                <ul class="list-unstyled link">
                    <li><a href="${pageContext.request.contextPath}/Rooms">The Rooms &amp; Suites</a></li>
                    <li><a href="${pageContext.request.contextPath}/About">About Us</a></li>
                    <li><a href="${pageContext.request.contextPath}/About">Contact Us</a></li>
                    <li><a href="${pageContext.request.contextPath}/Home#mains">Restaurant</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 mb-5">
                ...
                <form onsubmit="location.href = '${pageContext.request.contextPath}/Accounts'; return false;" class="footer-newsletter">
